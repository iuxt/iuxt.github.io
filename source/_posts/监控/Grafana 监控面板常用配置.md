...
tags:
  ...
  - grafana
abbrlink: lswszwbz
cover: 'https://s3.babudiu.com/iuxt/public/Grafana.svg'
...
![image.png](https://s3.babudiu.com/iuxt/images/202402221351583.png)

## 面板配置

可以手动配置，也可以在 grafana 官网下载别人配置好的模板：<https://grafana.com/grafana/dashboards/>, 复制 ID 或者下载 json 文件到本地
![image.png](https://s3.babudiu.com/iuxt/images/202402221354043.png)

然后在面板上面，点击 + ， 选择 import dashboard 使用 json 文件导入或者直接输入面板 id 进行导入。

![image.png](https://s3.babudiu.com/iuxt/images/202402221356021.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202402221739352.png)

在面板的设置 -- 变量中， 添加一个变量， 变量名可以自定义， 在此面板的查询语句中可以调用。 查询选项取 Label values， 要取的标签为 env， 要查询的语句为 node_uname_info（选一个覆盖面最广的语句）

![image.png](https://s3.babudiu.com/iuxt/images/202402221743652.png)

然后 Dashboard 的右上角就有了这个动态筛选框。
![image.png](https://s3.babudiu.com/iuxt/images/202402221744503.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202402221821000.png)

如下是根据 env 和 project 选择 ip：

![image.png](https://s3.babudiu.com/iuxt/images/202402221824179.png)

所有变量：
![image.png](https://s3.babudiu.com/iuxt/images/202402221842109.png)

效果如图，选择 dev 环境自动出现 ip 198， 选择 prod 自动出现 ip 199：
![image.png](https://s3.babudiu.com/iuxt/images/202402221825070.png)

![image.png](https://s3.babudiu.com/iuxt/images/202402221825184.png)

面板中的调用方式：

![image.png](https://s3.babudiu.com/iuxt/images/202402221840568.png)
