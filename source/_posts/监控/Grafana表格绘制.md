...
![image.png|918](https://s3.babudiu.com/iuxt/images/20241210104651576.png)
...
![image.png|970](https://s3.babudiu.com/iuxt/images/20241210104917046.png)

## 移除不想展示的字段

上面可以看到数据已经被关联成了一条，但是有很多不想显示的字段，在 `Transform data` 中增加一个 `Organize fields by name`，经过调整后

![image.png|937](https://s3.babudiu.com/iuxt/images/20241210105622474.png)

## 修改字段单位

上面的运行时间，单位是秒，需要调整一下单位，在 Override 中调整：

![image.png|1008](https://s3.babudiu.com/iuxt/images/20241210105842096.png)

## 给表格分配颜色

![image.png|1051](https://s3.babudiu.com/iuxt/images/20241223164145064.png)
