...
个人位置：`%appdata%\Microsoft\Windows\Start Menu`
...
比如我的 syncthing 数据就被保存到了 `C:\Windows\System32\config\systemprofile\AppData\Local\Syncthing` , 指定了当前用户的话是在 `%localappdata%\Syncthing`
