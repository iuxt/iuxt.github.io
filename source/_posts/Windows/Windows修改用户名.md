...
首先要区分一下什么是用户名
![image.png](https://s3.babudiu.com/iuxt/images/202403022109093.png)

![image.png](https://s3.babudiu.com/iuxt/images/202403022111200.png)

上面这些都不是用户名，而是显示出来的用户名，也就是用户名全名。可以在 `lusrmgr.msc` 或 `control userpasswords2` 或 `netplwiz` 查看:

![image.png](https://s3.babudiu.com/iuxt/images/202403022113496.png)
...
当前我的文件夹名字是 测试， 如图：
![image.png](https://s3.babudiu.com/iuxt/images/202403022118314.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202403022122885.png)

注销再次登录，会出现正在准备 windows 的提示，这个是正常的。进入桌面，出现下面的提示，点击关闭 (这一步也可以在 pe 下完成)
![image.png](https://s3.babudiu.com/iuxt/images/202403022125931.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202403022129458.png)
