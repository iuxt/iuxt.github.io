---
title: HTTPS的原理，使用HTTPS就一定是安全的吗？
categories:
  - 基础运维
tags:
  - tls
...
以前一直以为 HTTPS 是一种与 HTTP 类似的应用层协议，后来才发现 HTTPS 并不是一种协议。https 只是在 URI 中作为 protocol identifier 罢了。HTTPS 其实是 HTTP Over TLS（ [RFC2818](https://datatracker.ietf.org/doc/html/rfc2818) ）的简称，也就是运行在 TLS 协议上的 HTTP 协议，使用 TLS 协议对 HTTP 数据进行加密，从而保证了安全性。

## TLS 协议简介

HTTPS 的核心就是 TLS 协议，那么 TLS 协议又是什么呢？TLS 的全称为 Transport Layer Security，也就是在传输层保证安全 [RFC5246](https://tools.ietf.org/html/rfc5246)。主要分为以下四个协议：

- [handshake protocol](https://tools.ietf.org/html/rfc5246#page-37)，用来建立连接、身份认证、密钥协商
- [alert protocol](https://tools.ietf.org/html/rfc5246#page-28)，用来关闭连接
- [change cipher spec protocol](https://tools.ietf.org/html/rfc5246#page-27)，用来表示开始使用协商好的加密方式进行数据传输
- [application data protocol](https://tools.ietf.org/html/rfc5246#page-65)，用来传输密文
...
![41ac7d0df61046f0ab518fba866838dd.webp](https://s3.babudiu.com/iuxt/images/202411211110422.webp)

### 客户端请求建立连接

![image.png](https://s3.babudiu.com/iuxt/images/202411211139023.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202411211418010.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202411211418690.png)

证书的作用在 [“用数字证书证明你是你”](https://yieldnull.com/blog/001efdfe76e6f4f672faf785dff1cc54e4fd26ba/) 一文中已经阐明。

要是之前确定的加密套件中的秘钥交换算法还需要一些额外的信息，那么服务器还会发送一个 `Server Key Exchange`，用来传递额外的信息。

![image.png](https://s3.babudiu.com/iuxt/images/202411211419536.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202411211419375.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202411211420975.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202411211420400.png)
...
![image.png](https://s3.babudiu.com/iuxt/images/202411211420778.png)

### 加密套件与密钥

上一节仅介绍了握手的流程，现在来仔细看看其中涉及到的加密套件（[Cipher\_suite](https://en.wikipedia.org/wiki/Cipher_suite)）与 `master secret`。
...
![image.png](https://s3.babudiu.com/iuxt/images/202411211421527.png)
...
HTTP 协议被认为不安全是因为传输过程容易被监听者勾线监听、伪造 [服务器](https://cloud.tencent.com/product/cvm/?from_column=20065&from=20065)，而 HTTPS 协议主要解决的便是网络传输的安全性问题。

首先我们假设不存在认证机构，任何人都可以制作证书，这带来的安全风险便是经典的 **“中间人攻击”** 问题。

“中间人攻击”的具体过程如下：

![f35348523dd744408647d2b97d2534c6.webp](https://s3.babudiu.com/iuxt/images/202411211111399.webp)
...
![e7d864735b9d4ff9a42e761bd44ce513.webp](https://s3.babudiu.com/iuxt/images/202411211112715.webp)
...
![1e9f4c5925fc4929804b8a1bc94cdd87.png](https://s3.babudiu.com/iuxt/images/202411211112378.png)
...
- [TLS Handshake Protocol](https://msdn.microsoft.com/en-us/library/windows/desktop/aa380513%28v=vs.85%29.aspx)
- [The First Few Milliseconds of an HTTPS Connection](http://www.moserware.com/2009/06/first-few-milliseconds-of-https.html)
- [SSL/TLS原理详解](https://segmentfault.com/a/1190000002554673)
- [TLS/SSL握手过程](https://www.wosign.com/faq/faq2016-0309-04.htm)
- [ssl协议中的dh算法的pre-master-secret](http://blog.csdn.net/dog250/article/details/5717162)
- [Cipher\_suite](https://en.wikipedia.org/wiki/Cipher_suite)
- [用数字证书证明你是你](https://yieldnull.com/blog/001efdfe76e6f4f672faf785dff1cc54e4fd26ba/)