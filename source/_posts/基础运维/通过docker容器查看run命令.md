...
公司有一台服务器上运行着一个服务，通过 `docker start` 启动，已经没有文档记录如何搭建的了。现在需要迁移，记录一下获取 docker run 命令的方法

{% tabs TabName %}

<!-- tab 通过模版处理 docker inspect 的数据来获取 -->
模版文件来自<https://gist.githubusercontent.com/efrecon/8ce9c75d518b6eb863f667442d7bc679/raw/run.tpl>
